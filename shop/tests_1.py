...
#
#     class TestCategory (APIShopTest) :
...
#             #cette méthode créer les deux catégories pour celle active et
#             #une non-active
#             product = Product.objects.create(name='Banane', active=True)
#             Product.objects.create(name='Courgette', active=False)
#
#             #on réalise l'appel en GET en utilisant le client de la classe de
#             #tests
#             response = self.client.get(self.url)
